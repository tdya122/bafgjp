                ...
                if (_0x48db83 === '2.2') {
                  await _0x1ac136.sendMessage(
                    _0x231677,
                    {
                      ...
                      mimetype: 'audio/mpeg',
                      fileName: '𝐊𝐃 𝐏么𝐍𝐓么 𝐎𝐎.mp3',
                      caption:
                        '*AUDIO DOCUMENTS FILE 📁*\n\n> *©POWER BY KD PANTA 00*',
                    },
                    { quoted: _0x5ded0a }
                  )
                } else {
          ...
          if (_0x1e75d9 === '1.1') {
            await _0xaf8db8.sendMessage(
              _0x5eb615,
              {
                video: { url: _0x15a4a6 },
                caption:
                  '*\xA9 *> *© 𝙿𝙾𝚆𝙴𝙰𝚁𝙳 𝙱𝚈 𝙼𝙴𝚁𝙸 𝙼𝙳 ✾* \xB7 \xB7 \xB7\u2078\u2078\u2077*',
              },
              { quoted: _0x2405c0 }
            )
          } else {
    ...
    try {
      if (!_0x4564d6) {
        return await _0xc4807(
          '*please give search name ✒️*\n`👇 Example :`\n\n.cartoon tom and jery'
        )
      }
      const _0x2e5011 =
                ...
                _0x46edb0
                  ? await _0x5049fe.sendMessage(
                      _0x4a17a3,
                      {
                        ...
                        caption:
                          _0x1d0aed.title + ' |  > *© POWERDE KD PANTA 00',
                      },
                      { quoted: _0x171143 }
                    )
                  : await _0xc4807(
